...
import com.example.tomatomall.vo.LikeRequestVO;
...
public class LikeController {
    ...
    @PostMapping
    public Response<String> addLike(@RequestBody LikeRequestVO likeRequestVO) {
        Integer userId = likeRequestVO.getUserId();
        Integer postId = likeRequestVO.getPostId();
        Integer commentId = likeRequestVO.getCommentId();
        try {
    ...
    @DeleteMapping()
    public Response<String> removeLike(@RequestBody LikeRequestVO likeRequestVO) {
        Integer userId = likeRequestVO.getUserId();
        Integer postId = likeRequestVO.getPostId();
        Integer commentId = likeRequestVO.getCommentId();
        try {
